...
class AstExpandArrayFormulae
  ...
  FUNCTIONS_THAT_ACCEPT_RANGES_FOR_ALL_ARGUMENTS = {AVERAGE: true, COUNT: true, COUNTA: true, INTERCEPT: true, MAX: true, MIN: true, SLOPE: true, SUM: true, SUMPRODUCT: true, MMULT: true}
